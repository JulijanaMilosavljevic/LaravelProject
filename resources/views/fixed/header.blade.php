...
<div id="header">
    <div id="headerHolder">
        ...
        <h1 id="logo" class="widthHeaderElements"><a href="{{route("home")}}">Jewerly Store</a></h1>
        <div id="logReg" class="widthHeaderElements">
            <ul id="logRegList">
                @if(session()->has('user'))
                    <li><a href='#' id='hello'>{{ session("user")->username }}</a></li>
                    <li><a href='{{ url("/logout") }}'>Logout</a></li>
                    @endif
                @if(!session()->has('user'))
                    <li><a href="#" id="logLink">Log In</a></li>
                    <li><a href="#" id="regLink">Register</a></li>
                    @endif
                @if(session()->has('user'))
                        @if(session('user')->role_id == 2)
                            <li><a href="#" id="wishlistLink"><span class="fa fa-heart-o"></span>My Whishlist</a></li>
                        @endif
                    @endif
            </ul>
            <form id="registrationForm" action="#" method="POST">
                ...
                <table>
                    ...
                    <tr><td colspan="2"><input type="button" id="btnRegistration" value="Register"/></td></tr>
